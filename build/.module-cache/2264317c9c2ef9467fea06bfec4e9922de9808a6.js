        ...
        React.createElement("div", {className: "container"}, 
              ...
              React.createElement("div", {className: "panel panel-default"}, 
                ...
                React.createElement("div", {className: "panel-body lead"}, 
                  React.createElement("div", {className: "col-sm-3"}, 
                    React.createElement("a", {href: "http://ec2-54-68-172-39.us-west-2.compute.amazonaws.com", target: "_blank"}, React.createElement("img", {src: "img/screenshot-Kinector.jpg", alt: "", className: "screenshot"}))
                  ), 
                  React.createElement("div", {className: "col-sm-9"}, 
                  React.createElement("p", null, "Kinector is a user dashboard that allows users to communicate with other users. Once signed in, a user can view other users' profile page where he or she can post a new message or add a comment to an existing message. This app is built with administration functionality, allowing for one user to administer the other users.")
                  )
                )
              )
            )
          ...
          React.createElement("div", {className: "row"}, 
            React.createElement("div", {className: "col-sm-6"}, 
              React.createElement("div", {className: "panel panel-default project"}, 
                React.createElement("div", {className: "panel-heading"}, 
                  React.createElement("h2", {className: "panel-title"}, "Kinector")
                ), 
                React.createElement("div", {className: "panel-body lead"}, 
