      ...
      React.createElement("div", {id: "services", className: "services"}, 
        React.createElement("div", {className: "container"}, 
          ...
          React.createElement("div", {className: "row text-center"}, 
            React.createElement("div", {className: "col-sm-2 col-sm-offset-1 col-xs-4"}, 
              React.createElement("h4", null, "Languages"), 
              React.createElement("p", null, "HTML5, CSS3, JavaScript, PHP5, Swift, Python")
            ), 
            React.createElement("div", {className: "col-sm-2 col-xs-4"}, 
            ...
            React.createElement("div", {className: "col-sm-2 col-xs-4"}, 
              React.createElement("h4", null, "Etc."), 
              React.createElement("p", null, "OOP, REST, AJAX, Git, GitHub")
            )
