var Header = React.createClass({displayName: "Header",
  onClick: function(e){
    ...
    console.log('Made it');
     ...
     $div = $(this);
     var className=$div.attr('className');
          ...
          React.createElement("div", {className: "container-fluid"}, 
            ...
            React.createElement("div", {className: "collapse navbar-collapse", id: "links"}, 
              React.createElement("ul", {className: "nav navbar-nav"}, 
                React.createElement("li", null, React.createElement("a", {href: "#", className: "link", onClick: this.onClick, value: "hello", ref: "target"}, "About")), 
