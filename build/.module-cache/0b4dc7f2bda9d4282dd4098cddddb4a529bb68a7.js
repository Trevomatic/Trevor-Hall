    ...
    return(
      React.createElement("div", {id: "services", className: "services"}, 
        React.createElement("div", {className: "container"}, 
          ...
          React.createElement("p", {className: "text-center"}, React.createElement("a", {href: "#", className: "btn btn-default btn-lg", onClick: this.onClick.bind(null, 'projects')}, 
          React.createElement("img", {src: "img/down_arrow.png", alt: ""})
          ))
        )
      )
    );
