...
var Services = React.createClass({displayName: "Services",
  render: function() {
    return(
      React.createElement("div", {id: "services", class: "pad-section"}, 
        React.createElement("div", {class: "container"}, 
          React.createElement("h2", {class: "text-center"}, "Our Services"), " ", React.createElement("hr", null), 
          React.createElement("div", {class: "row text-center"}, 
            React.createElement("div", {class: "col-sm-3 col-xs-6"}, 
              React.createElement("i", {class: "glyphicon glyphicon-cloud"}, " "), 
            ...
            React.createElement("div", {class: "col-sm-3 col-xs-6"}, 
              React.createElement("i", {class: "glyphicon glyphicon-leaf"}, " "), 
              React.createElement("h4", null, "Service 2"), 
              React.createElement("p", null, "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec in sem cras amet. Donec in sem cras amet.")
            ), 
            React.createElement("div", {class: "col-sm-3 col-xs-6"}, 
              React.createElement("i", {class: "glyphicon glyphicon-phone-alt"}, " "), 
              React.createElement("h4", null, "Service 3"), 
              React.createElement("p", null, "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec in sem cras amet. Donec in sem cras amet.")
            ), 
            React.createElement("div", {class: "col-sm-3 col-xs-6"}, 
              React.createElement("i", {class: "glyphicon glyphicon-bullhorn"}, " "), 
