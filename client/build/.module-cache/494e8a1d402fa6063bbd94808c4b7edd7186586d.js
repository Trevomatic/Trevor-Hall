    ...
    return(
      React.createElement("div", {id: "home", className: "home"}, 
        React.createElement("div", {className: "text-vcenter"}, 
          ...
          React.createElement("a", {href: "#pad", className: "btn btn-default btn-lg"}, "Continue")
        )
      )
    );
  }
...
var Pad = React.createClass({displayName: "Pad",
  render: function() {
    return(
      React.createElement("div", {id: "pad", className: "pad"}, 
      ...
      React.createElement("div", {id: "about", className: "about"}, 
        React.createElement("div", {className: "container"}, 
          React.createElement("div", {className: "row"}, 
            ...
            React.createElement("div", {id: "bio", className: "col-sm-10 col-sm-offset-1 text-center"}, 
