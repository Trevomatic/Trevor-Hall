                ...
                React.createElement("nav", {className: "navbar navbar-default"}, 
                  ...
                  React.createElement("div", {class: "collapse navbar-collapse", id: "bs-example-navbar-collapse-1"}, 
                    React.createElement("ul", {class: "nav navbar-nav"}, 
                      React.createElement("li", {class: "active"}, React.createElement("a", {href: "#"}, "Link ", React.createElement("span", {class: "sr-only"}, "(current)"))), 
                      React.createElement("li", null, React.createElement("a", {href: "#"}, "Link")), 
                      React.createElement("li", {class: "dropdown"}, 
                        React.createElement("a", {href: "#", class: "dropdown-toggle", "data-toggle": "dropdown", role: "button", "aria-haspopup": "true", "aria-expanded": "false"}, "Dropdown ", React.createElement("span", {class: "caret"})), 
                    ...
                    React.createElement("form", {class: "navbar-form navbar-left", role: "search"}, 
