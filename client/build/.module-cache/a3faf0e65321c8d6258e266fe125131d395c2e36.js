          ...
          React.createElement("div", {className: "row text-center"}, 
            React.createElement("div", {className: "col-sm-2"}, 
              ...
              React.createElement("ul", null, 
                React.createElement("li", null, React.createElement("h4", null, "Frameworks")), 
                React.createElement("li", null, "Express"), 
                React.createElement("li", null, "CodeIgniter"), 
                React.createElement("li", null, "AngularJS"), 
                React.createElement("li", null, "Bootstrap"), 
                React.createElement("li", null, "JQuery"), 
                React.createElement("li", null, "SocketIO"), 
                React.createElement("li", null, "Materialize")
                )
                )
            ), 
