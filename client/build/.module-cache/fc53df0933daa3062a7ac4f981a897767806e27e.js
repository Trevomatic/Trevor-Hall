...
var Home = React.createClass({displayName: "Home",
    ...
    element_to_scroll_to.scrollIntoView({beavior: 'smooth'});
   },
  render: function() {
    return(
      React.createElement("div", {id: "home", className: "home"}, 
        React.createElement("div", {className: "text-vcenter"}, 
          ...
          React.createElement("h3", null, React.createElement("a", {className: "btn btn-primary btn-lg", onClick: this.onClick.bind(null, 'about')}, "LEARN MORE ABOUT ME"))
        )
      )
    );
  }
